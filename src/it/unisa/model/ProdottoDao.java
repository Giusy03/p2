...
public class ProdottoDao implements ProdottoDaoInterfaccia {
    ...
    public synchronized ArrayList<ProdottoBean> doRetrieveAll(String order) throws SQLException {
        ...
        // Only allow specific, safe column names to be used for ordering
        ...
        if (order != null && !order.equals("")) {
            switch (order) {
                ...
                case "QUANTITA":
                    ...
                    break;
                default:
                    // If the provided order is not valid, throw an exception or handle accordingly
                    throw new SQLException("Invalid order parameter.");
            }
        }
